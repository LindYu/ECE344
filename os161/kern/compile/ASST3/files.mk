...
memcmp.o: ${S}/../lib/libc/memcmp.c
	${COMPILE.c} ${S}/../lib/libc/memcmp.c
SRCS+=${S}/../lib/libc/memcmp.c
OBJS+=memcmp.o
...
iosyscall.o: ${S}/userprog/iosyscall.c
	${COMPILE.c} ${S}/userprog/iosyscall.c
SRCS+=${S}/userprog/iosyscall.c
OBJS+=iosyscall.o

procsyscall.o: ${S}/userprog/procsyscall.c
	${COMPILE.c} ${S}/userprog/procsyscall.c
SRCS+=${S}/userprog/procsyscall.c
OBJS+=procsyscall.o

timesyscall.o: ${S}/userprog/timesyscall.c
	${COMPILE.c} ${S}/userprog/timesyscall.c
SRCS+=${S}/userprog/timesyscall.c
OBJS+=timesyscall.o
